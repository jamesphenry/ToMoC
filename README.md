> ## 🔌 Sovereign compute cost so far: **$0.2358**
> 49 training/eval passes · 18.71 GPU-hrs · 14¢/kWh · ~90W over server idle
...
How-to for the interactive loop: [docs/PLAYGROUND.md](docs/PLAYGROUND.md).
